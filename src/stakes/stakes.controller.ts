...
export class StakesController {
  ...
  @ApiOperation({
    ...
    description: `Inititate a stake by idempotently reserving a <code>validator</code> for the specific client. Requires an idempotent key.
        <br><br>
        It takes the supplied <code>withdrawal_pubkey</code>, the amount which <strong>must</strong> be an integer multiple of 32,000,000,000 <code>Gwei</code> (32 <code>ETH</code>) and a <code>fee_recipient</code> ETH1 address.
        <br><br>
